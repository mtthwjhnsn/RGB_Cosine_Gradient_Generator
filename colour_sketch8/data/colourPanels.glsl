...
// compute colors
   ...
   int amp_lfo_type = 1;
   int freq_lfo_type = 1;
   int phase_lfo_type = 1;
   float amp_lfo_speed = 0.92;
   float freq_lfo_speed = 0.4;
   float phase_lfo_speed = 0.2;
   float amp_lfo_amp = 0.0;
   float freq_lfo_amp = 0.0;
   float phase_lfo_amp = 0.50;
   float amp_cycle_speed = 0.0;
   float freq_cycle_speed = 0.0;
   float phase_cycle_speed = 0.1;
